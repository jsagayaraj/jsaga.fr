...
<html lang="en">
  <head>
    ...
    <title>Roux Academy Conference 2013</title>
    ...
    <div class="container">
      <div class="content row">
        ...
        <section class="main col col-lg-8">
          ...
          <?php include ('_/php/article-abouttheartists.php'); ?>
          <?php include ('_/php/article-aboutthevenue.php'); ?>
        </section><!-- main -->
        ...
        <section class="sidebar col col-lg-4">
          ...
          <?php include ('_/php/aside-accordion.php'); ?>
        </section><!-- sidebar -->
